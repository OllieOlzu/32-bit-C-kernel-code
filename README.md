...
If you have used https://github.com/OllieOlzu/Easy-32-bit-C-kernel-to-ISO to run these, the way all of these scripts restart is by rebooting the CPU, which works fine if you have the preset I made for grub.cfg, but if you add another bin file for grub to boot it will land you there instead of restarting the game. If you want to add this to your own scripts, here's how to:
